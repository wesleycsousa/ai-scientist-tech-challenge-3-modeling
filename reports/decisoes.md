...
|---|---|---|---|
| Random Forest | `n_estimators=200, max_depth=None, min_samples_leaf=1` | 0,7479 | 88,9s |
| SVM | `C≈15,70, gamma≈0,00625` (kernel RBF) | 0,7465 | 1050,0s (cerca de 17,5min) |
| Regressão Logística | `C=10, penalty=l1 (liblinear)` | 0,7379 | 21,2s |
| Árvore de Decisão | `max_depth=None, min_samples_leaf=50, criterion=gini` | 0,7294 | 70,7s |
